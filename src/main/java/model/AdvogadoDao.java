...
public class AdvogadoDao {
	...
	public ArrayList<Advogado> Listar() {
		try {
			...
			/*
			 * idadv INT PRIMARY KEY AUTO_INCREMENT, dataadv TIMESTAMP DEFAULT
			 * CURRENT_TIMESTAMP, oab VARCHAR(15) UNIQUE NOT NULL, nome VARCHAR(127) NOT
			 * NULL, telefone VARCHAR(31) NOT NULL, statusadv ENUM("on", "off") DEFAULT "on"
			 */
